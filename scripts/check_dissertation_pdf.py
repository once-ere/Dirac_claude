...
#
# Origin: scripts/check_dissertation_pdf.py of
# https://github.com/once-ere/dirac (GPL-3.0-or-later), copied into this
# repository on 2026-09-25.
#
# Changes relative to the origin: this header only.  The code is unchanged.
# It is used here as the PDF-structure library of check_provenance_pdf.py and
# build_provenance_pdf.py (verify_pdf, parse_media_boxes, sha256_bytes).  The
# two editions registered below ("original", "learn") are the dirac-main
# dissertation PDFs; those files are not part of this repository, so the
# command-line default only works inside a dirac-main checkout.  Editions of
# this repository are registered in provenance/pdf-specifications.json and
# checked with scripts/check_provenance_pdf.py.
