// Origin: studies/dirac16complex_cosmology/src/output.rs (Stage 3 of this
// repository, GPL-3.0-or-later), copied into the Stage-4 crate on 2026-09-25;
// only the crate constants it refers to (STUDY, SCHEMA_VERSION, FIXTURE_*,
// ENGINE) now come from the Stage-4 lib.rs.
